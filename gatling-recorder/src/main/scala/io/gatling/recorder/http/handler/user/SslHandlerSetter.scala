...
import io.gatling.recorder.http.ssl.ServerSslEngineFactory
 ...
 */
class SslHandlerSetter(domainAlias: String, sslEngineFactory: ServerSslEngineFactory) extends ChannelDownstreamHandler with StrictLogging {
